...
const recordsByDay = [
  {
    ...
    total: "1,350 ml",
    records: [
      { id: 1, name: "馥芮白",     brand: "星巴克",   time: "09:24", volume: 350, calories: 130, caffeine: 150, sugar: 12, category: "咖啡", bg: "#fff7ed", accent: "#f97316", gradient: "linear-gradient(90deg, #f97316, #eab308)", icon: "☕" },
      { id: 2, name: "纯净水",     brand: "农夫山泉", time: "11:05", volume: 500, calories: 0,   caffeine: 0,   sugar: 0,  category: "水",   bg: "#eff6ff", accent: "#3b82f6", gradient: "linear-gradient(90deg, #3b82f6, #06b6d4)", icon: "💧" },
      { id: 3, name: "燕麦拿铁",   brand: "瑞幸咖啡", time: "14:30", volume: 400, calories: 120, caffeine: 75,  sugar: 9,  category: "咖啡", bg: "#fdf4ff", accent: "#a855f7", gradient: "linear-gradient(90deg, #f97316, #eab308)", icon: "🥛" },
      { id: 4, name: "柠檬蜂蜜水", brand: "自制",     time: "17:10", volume: 300, calories: 48,  caffeine: 0,   sugar: 12, category: "果汁", bg: "#f0fdf4", accent: "#10b981", gradient: "linear-gradient(90deg, #10b981, #14b8a6)", icon: "🍋" },
    ]
  },
  {
    date: "昨天  ·  3月14日",
    total: "2,100 ml",
    records: [
      { id: 5, name: "美式咖啡",   brand: "精品咖啡馆", time: "08:30", volume: 400, calories: 15,  caffeine: 180, sugar: 0,  category: "咖啡", bg: "#fff7ed", accent: "#f97316", gradient: "linear-gradient(90deg, #f97316, #eab308)", icon: "☕" },
      { id: 6, name: "绿茶",       brand: "茶里王",     time: "10:15", volume: 500, calories: 3,   caffeine: 35,  sugar: 0,  category: "茶饮", bg: "#f0fdf4", accent: "#10b981", gradient: "linear-gradient(90deg, #10b981, #059669)", icon: "🍵" },
      { id: 7, name: "矿泉水",     brand: "依云",       time: "13:20", volume: 500, calories: 0,   caffeine: 0,   sugar: 0,  category: "水",   bg: "#eff6ff", accent: "#3b82f6", gradient: "linear-gradient(90deg, #3b82f6, #06b6d4)", icon: "💧" },
      { id: 8, name: "芒果奶茶",   brand: "茶百道",     time: "15:45", volume: 700, calories: 310, caffeine: 30,  sugar: 52, category: "奶茶", bg: "#fdf4ff", accent: "#8b5cf6", gradient: "linear-gradient(90deg, #ec4899, #db2777)", icon: "🧋" },
    ]
  }
]
  ...
  return (
    <div className="flex flex-col gap-6 pb-4">
      ...
      <div className="flex items-center justify-between pt-1">
        ...
        <button className="w-10 h-10 flex items-center justify-center rounded-2xl" style={{ background: 'rgba(255, 255, 255, 0.5)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)', border: '1px solid rgba(255, 255, 255, 0.4)', boxShadow: '0 4px 16px rgba(0, 0, 0, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.9)' }}>
        ...
        {filters.map(f => (
          <button
            ...
            style={activeFilter === f 
              ? { background: getGradient(f === "全部" ? "水" : f), boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)' }
